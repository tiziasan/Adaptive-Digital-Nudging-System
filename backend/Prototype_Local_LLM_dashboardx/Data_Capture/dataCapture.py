...
class DataCapture:
    ...
    Domain: Sustainability - Energy consumption monitoring for electrodomestic appliances
    """
    ...
    def collect_behavioral_data(self,
        ...
        """
        Component 1: Behavioral Collector
        Captures user interactions with electrodomestic appliances in the dashboard

        Args:
            electrodomestic_interactions: List of appliance interactions, each containing:
                - appliance_type: e.g., 'washing_machine', 'refrigerator', 'dishwasher'
                - clicks: number of clicks on this appliance
                - scrolls: number of scrolls on this appliance's details
                - hesitation: hesitation time in milliseconds (mouse hover)
                - usage_hours_yesterday: actual running time of appliance in last 24 hours
                - usage_hours_last_week: actual running time of appliance in last 7 days
                - appliance_watt_consumption: power consumption in watts

        Returns:
            Dictionary with behavioral data organized by electrodomestic appliances
        """
        behavioral_data = {
    ...
    def collect_context_data(self,
        ...
        # Auto-detect time_of_day if not provided
    ...
    def capture_all(self,
                    ...
                    device_type: str = None) -> Dict[str, Any]:
        """
        Merges behavioral and context data into a single dictionary

        Args:
            electrodomestic_interactions: List of appliance interactions
            time_of_day: Time of day
            location: User location
            device_type: Device type

        Returns:
            Single merged dictionary with both behavioral and context data
        """
